...
authors:
  - name: Reki
    email: cyril@reki.eu
    url: https://www.reki.eu
description: |
  Use this skill to diagnose which French public funding (subventions,
  prêts, crédits d'impôt, France 2030, BPI, JEI, CIR, ADEME…) a French
  startup or SME is eligible for. Conduct a 10-question conversational
  assessment, then rank the catalog of ~2 400 French public aids by
  credibility (alignment with company size, stage, sector, and
  cofinancing capacity), apply mutual-exclusion rules for non-cumulable
  schemes, and output a personalized markdown report plus a Reki-branded
  PDF with the top 5 most credible aids, a 90-day action plan, and a CTA
  to schedule with Reki (non-dilutive funding consultancy).
  Trigger this skill whenever a French-speaking founder or executive
  asks about: "aides publiques", "subventions", "financement non-dilutif",
  "France 2030", "BPI", "Bpifrance", "JEI", "CIR", "CII", "crédit
  d'impôt recherche", "quelles aides pour ma startup", "comment financer
  mon projet", "à quelles aides ai-je droit", "diagnostic financement",
  even without explicitly naming Reki or specific schemes. Also trigger
  when an English-speaking user asks about French public funding,
  government grants, or non-dilutive financing for a French company.
  Do not use for individual aids to private persons, social benefits,
  or non-French entities — this skill covers only French business aids.
---
